...
class Content extends Equatable {
  ...
  factory Content.fromSnapshot(DocumentSnapshot snapshot) {
    final data = snapshot;
    return Content(
      id: data.id,
      title: data['title'],
      ...
      casts: List<String>.from(data['casts']),
      directors: List<String>.from(data['directors']),
  ...
  static List<Content> contents = [
    ...
    Content(
      ...
      directors: const ["Hanung Bramantyo"],
    ...
    Content(
      ...
      directors: const ["David Benioff", "D. B. Weiss"],
      thumbnailUrl:
