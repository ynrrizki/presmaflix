...
class _DownloadPageState extends State<DownloadPage> {
  List<Content> downloadedContent = Content.downloadedContent;
  ...
  void initState() {
    super.initState();
    selectedItems = List.generate(downloadedContent.length, (index) => false);
  }
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: ListView.builder(
          ...
          itemCount: downloadedContent.length,
                ...
                hasSelectedItems
                    ...
                    : Navigator.of(context, rootNavigator: true).pushNamed(
                        ...
                        arguments: ContentDetailArguments(
                          content: downloadedContent[index],
                        ),
                      );
              }
            },
            ...
            ? FloatingActionButton(
                ...
                onPressed: () {
                  ...
                  for (int i = 0; i < selectedItems.length; i++) {
                    if (selectedItems[i]) {
                      selectedContent.add(downloadedContent[i]);
                    }
                  }
                  showDialog(
                    context: context,
                    builder: (context) => AlertDialog(
                      title: const Text('Items Downloaded'),
                      content: Column(
